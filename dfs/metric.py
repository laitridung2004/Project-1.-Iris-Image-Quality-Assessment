...
model_segment_path = "weights\iris_semseg_upp_scse_mobilenetv2.onnx"
input_image_path = "test_image\average_image.jpg"
...
def process_image_and_calculate_metrics(image):
    ...
    iriss = mask_iris_resized - mask_pupil_resized
